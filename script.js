...
function calculateTripCost() {
    ...
    showResult(
        ...
        `
            ...
            Обща цена: <strong>${formatNumber(totalCost)} ${currency}</strong><br>
            Цена на км: <strong>${formatNumber(costPerKm)} ${currency}/км</strong><br>
            Цена на човек: <strong>${formatNumber(costPerPerson)} ${currency}</strong>
        `
    );
}
